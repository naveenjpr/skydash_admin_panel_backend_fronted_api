              ...
              <div className="flex gap-4">
                <div className="w-[25%]">
                  <select
                    name=""
                    id=""
                    onChange={(e) => setcatelog(e.target.value)}
                    className="w-full h-[45px]  rounded-[3px] px-3 border border-[gray] text-[gray]"
                  >
                ...
                <div className="w-[35%] flex items-center relative">
                  <input
                    ...
                    className="w-full h-[45px] rounded-[3px] px-3 border border-[gray] focus:outline-none "
                    placeholder="Search Our Course"
                  />
                  <FontAwesomeIcon
                    icon={faSearch}
                    className="absolute text-[gray] text-[20px] top-[13px] right-[10px] z-[99]"
                  />
                </div>
              </div>
            </form>
          ...
          <div className=" py-5 px-3">
            <div className="faq border-[2px] rounded-[10px] py-6 ">
              ...
              <ul
                className={`mx-[25px]   ${
                  faq != true
                    ? "duration-[1s] mt-4 visible opacity-[1] max-h-[500px]"
                    : "mt-0 duration-[1s] invisible opacity-0 max-h-[0]"
                } `}
              >
